...
GTalkAccount.prototype = {
  ...
  connect: function() {
    ...
    if (!this._jid.node) {
      ...
      this._jid.domain = "manoderecha.mx";
...
GTalkProtocol.prototype = {
  ...
  get name() _("manoderecha.protocolName"),
  get normalizedName() "manoderecha",
  get iconBaseURI() "chrome://prpl-manoderecha/skin/",
  get usernameEmptyText() _("manoderecha.usernameHint"),
  ...
  classID: Components.ID("{d292dc1c-1b71-4ab4-9dea-a4477aa853e2}")
};
